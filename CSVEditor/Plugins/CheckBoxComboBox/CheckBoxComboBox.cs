...
namespace PresentationControls
{
    ...
    public partial class CheckBoxComboBox : PopupComboBox
    {
        ...
        /// </summary>
        public string GetCSVText(bool skipFirstItem)
        {
    ...
    public class CheckBoxComboBoxListControl : ScrollableControl
    {
        ...
        public void SynchroniseControlsWithComboBoxItems()
        {
            ...
            for (int Index = _Items.Count - 1; Index >= 0; Index--)
            {
                ...
                {
#pragma warning disable CS0618 // 'CheckBoxComboBoxItemList.Remove(CheckBoxComboBoxItem)' is obsolete: 'Do not remove items from this list directly. Use the ComboBox items instead.'
                    _Items.Remove(Item);
#pragma warning restore CS0618 // 'CheckBoxComboBoxItemList.Remove(CheckBoxComboBoxItem)' is obsolete: 'Do not remove items from this list directly. Use the ComboBox items instead.'
                    Item.Dispose();
                }
            }
...
#pragma warning disable CS0618 // 'CheckBoxComboBoxItemList.Add(CheckBoxComboBoxItem)' is obsolete: 'Do not add items to this list directly. Use the ComboBox items instead.'
                NewList.Add(Item);
#pragma warning restore CS0618 // 'CheckBoxComboBoxItemList.Add(CheckBoxComboBoxItem)' is obsolete: 'Do not add items to this list directly. Use the ComboBox items instead.'
